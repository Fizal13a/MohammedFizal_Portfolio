        ...
        <main className="px-6 md:px-12 lg:px-24 py-24 max-w-7xl mx-auto space-y-32">
          ...
          <section id="professional" className="scroll-mt-28">
             <div className="flex items-end gap-4 mb-20 border-b border-zinc-800 pb-6">
                ...
                <span className="text-zinc-500 font-mono text-sm mb-1 pb-1">/ SELECTED PROJECTS</span>
             </div>
          ...
          <section id="personal" className="scroll-mt-28">
             <div className="flex items-end gap-4 mb-20 border-b border-zinc-800 pb-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white">Personal Projects</h2>
                <span className="text-zinc-500 font-mono text-sm mb-1 pb-1">/ EXPERIMENTS & JAMS</span>
             </div>
          ...
          <section id="tools" className="scroll-mt-28">
             <div className="flex items-end gap-4 mb-20 border-b border-zinc-800 pb-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white">Tools</h2>
                <span className="text-zinc-500 font-mono text-sm mb-1 pb-1">/ Editor Tools</span>
             </div>
